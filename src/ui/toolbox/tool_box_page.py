...
class ToolBoxPage(QFrame):
    ...
    def __init__(self) -> None:
        ...
        back_btn.setStyleSheet(
            "QLabel { color: #e0e0f0; font-size: 13px; padding: 4px 12px; }"
        ...
        status_label = QLabel("")
        status_label.setStyleSheet("color: #9898b0; font-size: 12px;")
    ...
    def _on_apply_operations(self, params: OperationParams) -> None:
        ...
        if not images:
            ...
            self._status_label.setStyleSheet("color: #ffaa00; font-size: 12px;")
            return
        ...
        self._status_label.setStyleSheet("color: #9898b0; font-size: 12px;")
        ...
        def _on_success(results):
            ...
            if fail_count:
                ...
                self._status_label.setStyleSheet("color: #4dff4d; font-size: 12px;")
